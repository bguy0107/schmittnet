...
export default async function SubmitLandingPage({ params }: PageProps) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4 py-12 dark:bg-gray-950">
      <div className="w-full max-w-sm space-y-4">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">What would you like to do?</h1>
        </div>
        ...
        >
          ...
          <div>
            <p className="font-semibold text-gray-900 dark:text-gray-100">Open a Ticket</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Report a new IT or maintenance issue</p>
          </div>
        </Link>
