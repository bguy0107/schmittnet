    ...
    <main className="min-h-screen bg-gray-50 px-4 py-8 dark:bg-gray-950">
      <div className="mx-auto max-w-lg">
        <div className="mb-6">
          ...
          <h1 className="mt-3 text-2xl font-bold text-gray-900 dark:text-gray-100">Tickets</h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Active and recent tickets for this location.</p>
        </div>
